...
@IBDesignable
class OldRatingStateView: UIView {
    
    var state: PortannictRatingState?
    ...
    func set(ratingState: PortannictRatingState) {
        state = ratingState
    ...
    private func commonInit() {
        ...
        let nib = UINib(nibName: String(describing: OldRatingStateView.self), bundle: bundle)
